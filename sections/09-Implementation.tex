...
The \textbf{ACAD correlation module}, as shown in Figure \ref{fig:top_level_ACAD}, is responsible for computing the ACAD correlation matrix $\Tilde{\textbf{R}}_{k x k}(\textbf{x}).
\\
